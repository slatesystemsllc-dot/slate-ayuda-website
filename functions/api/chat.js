...
var SYSTEM_PROMPT = [
  ...
  '- Direct review-request form: yoursite.com/marketing-form (the same form, direct link).',
  ...
  '- SMS Commands: Text these words to +1 (831) 230-8743: REFER (get your referral link), LINK (your link + hub), BALANCE (see earnings), STATS (see full referral list).',

  '- Partner Hub (the MAIN place, everything lives there): partners.slatesystems.io/your-code -- your share link, QR code, ready message templates, live balance and referral list. Spanish-language hub: socios.slatesystems.io/your-code.',
  '- Lost your hub link? Text LINK to the number above and the system sends it back.',  '- 60-day cookie. First click wins. Any trade. Paid 1st of every month via Stripe.',
...
var SYSTEM_PROMPT_ES = [
  ...
  '- Formulario directo para pedir reseñas: tusitio.com/formulario-marketing (el mismo formulario, enlace directo).',
  'Más info: /resenas',
  '',
  '## CHAT Y MENSAJES',
  ...
  '- Comandos SMS: Envía estas palabras al +1 (831) 226-7831: REFERIR (obtén tu enlace de referido), LINK (tu enlace y tu hub), ESTADO o BALANCE (tu saldo), STATS (tu lista completa de referidos).',

  '- Tu Centro de Socio (el lugar PRINCIPAL, todo vive ahí): socios.slatesystems.io/tu-codigo -- tu enlace para compartir, tu código QR, plantillas de mensajes listas, tu saldo y tus referidos en vivo.',
  '- ¿Perdiste tu enlace? Envía LINK al número de arriba y el sistema te lo manda de nuevo.',  '- Cookie de 60 días. Primer clic gana. Cualquier oficio. Se paga el 1ro de cada mes por Stripe.',
